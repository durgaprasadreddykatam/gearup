...
const Coverage = (props) => {
    const [coverage, setCoverage] = React.useState('Essential_Coverage');
  ...
  return (
        ...
        <div className='py-10 flex-col border-b-2 border-b-gray-500'>
            ...
            <div className='flex justify-around flex-col sm:flex-row'>
                <div onClick={()=>{setCoverage(Essential_Coverage)}} id='Essential_Coverage' className={`flex flex-col cursor-pointer justify-between  sm:w-1/3 sm:rounded-xl ${coverage=== Essential_Coverage ? `border-blue-500`:`border-gray-500` }  sm:border-2 sm:m-2 sm:p-4 mt-5`}>
                ...
                <div  onClick={()=>{setCoverage(Standard_Coverage)}} id='Standard_Coverage'  className={`flex flex-col cursor-pointer justify-between  sm:w-1/3 sm:rounded-xl  ${coverage=== Standard_Coverage ? `border-blue-500`:`border-gray-500` } sm:border-2 sm:m-2 sm:p-4 mt-5`}>
                    <div className='flex flex-row justify-between items-center'>
                        <div className='flex flex-col'>
                ...
                <div onClick={()=>{setCoverage(I_have_my_own)}} id='I_have_my_own' className={`flex flex-col cursor-pointer justify-between  sm:w-1/3 sm:rounded-xl  ${coverage=== I_have_my_own ? `border-blue-500`:`border-gray-500` } sm:border-2 sm:m-2 sm:p-4 mt-5`}>
                    <div className='flex flex-row justify-between items-center'>
                        <div className='flex flex-col'>
